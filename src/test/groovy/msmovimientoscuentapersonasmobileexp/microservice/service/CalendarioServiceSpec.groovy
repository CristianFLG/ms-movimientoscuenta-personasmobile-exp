...
class CalendarioServiceSpec extends Specification {
    ...
    def "Quiero obtener los prox 20 dias habiles a partir de 4 dias" () {
        ...
        2        | LocalDate.of(2021,04,2)      || "08/01/2021"|| "04/02/2021"  // "Desde lunes 4 de enero,despues de año nuevo"
    ...
    def "Quiero obtener los prox 20 dias habiles a partir de 2 dias con comunas" () {
        ...
        ['LUN', 'MIE', 'VIE'] | 2         | LocalDate.of(2021, 12, 13) || "17/12/2021" || "02/02/2022" // "Desde lunes 13 de diciembre, se hablitan lunes,miercoles y viernes. se pasa por el 25 y 31 de diciembre'navidad y feriado bancario'. cambio de año 1ro de enero feriado"
        ...
        ['LUN','MAR','MIE','VIE'] | 2     | LocalDate.of(2021, 12,07)  || "13/12/2021" || "17/01/2022" // "Desde martes 7 de diciembre, se habilita el lunes, martes, miercoles y viernes. se pasa por el 8,25 y 31 de diciembre 'la concepcion, navidad y feriado bancario'. cambio de año 1ro de enero"
    }
